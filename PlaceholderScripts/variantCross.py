...
def create_cross_geometry(start_level , end_level) : 
    ...
    # first_random_list_x_long = [random.randint(0, 1) for _ in range(len(partition_lines_x_long))]
    # first_random_list_x_short = [random.randint(0, 1) for _ in range(len(partition_lines_x_short))]
    ...
    file_name = f"{IN[10]}/partition_walls.txt"
